...
#sudo scutil --set ComputerName "STALINGRAD"
#sudo scutil --set HostName "STALINGRAD"
#sudo scutil --set LocalHostName "STALINGRAD"
#sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "STALINGRAD"
...
echo "Done. Please restart for all settings to take"
